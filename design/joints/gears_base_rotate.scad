// ============================================================
// gears_base_rotate.scad — BASE ROTATION GEAR KIT
// ------------------------------------------------------------
// Four gears + one shim for the base rotation joint.
// 30:1 gear ratio (same as shoulder) for maximum torque at the base.
...
// Base rotation gear ratio: 30:1 (strongest joint, same as shoulder)
