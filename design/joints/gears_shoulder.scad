// ============================================================
// gears_shoulder.scad — SHOULDER GEAR KIT
// ------------------------------------------------------------
// Four gears + one shim for the shoulder joint, laid out side by side.
// 30:1 gear ratio (14->84 x 16->80) for maximum torque at the base.
...
// Shoulder gear ratio: 30:1 (strongest joint)
