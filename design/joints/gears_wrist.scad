// ============================================================
// gears_wrist.scad — WRIST GEAR KIT
// ------------------------------------------------------------
// Four gears + one shim for the wrist joint.
// 15:1 gear ratio (14->70 x 16->48) for fastest movement with least torque.
...
// Wrist gear ratio: 15:1 (fastest joint, least torque needed)
